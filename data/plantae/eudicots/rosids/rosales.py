...
C_SATIVA = Species(
    ...
    known_for=[{EN: 'THC'}, {EN: 'marijuana'}, {EN: 'hashish', PL: 'haszysz'}, {EN: 'hemp'}],
)
C_INDICA = Species(
    name='Cannabis indica',
    local_names={PL: 'konopie indyjskie'},
    known_for=[{EN: 'marijuana'}, {EN: 'hashish', PL: 'haszysz'}, {EN: 'higher concentrations of THC'}],
)
H_LUPULUS = Species(
...
A_ALTILIS = Species(name='Artocarpus altilis', local_names={EN: 'breadfruit', PL: 'chlebowiec właściwy'})
A_HETEROPHYLLUS = Species(
    name='Artocarpus heterophyllus',
    local_names={EN: 'jackfruit', PL: 'drzewo bochenkowe, dżakfrut, chlebowiec różnolistny'},
)
M_ALBA = Species(name='Morus alba', local_names={EN: 'white mulberry', PL: 'morwa biała'})
U_DIOICA = Species(name='Urtica dioica', local_names={EN: 'common nettle', PL: 'pokrzywa zwyczajna'})
