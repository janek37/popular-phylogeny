...
A_OCCIDENTALE = Species(name='Anacardium occidentale', local_names={EN: 'cashew', PL: 'nerkowiec, nanercz zachodni'})
M_INDICA = Species(name='Mangifera indica', local_names={EN: 'mango', PL: 'mango indyjskie'})
S_MOLLE = Species(
    name='Schinus molle',
    local_names={EN: 'Peruvian pepper tree', PL: 'schinus peruwiański'},
    known_for=[{EN: 'pink peppercorn', PL: 'pieprz czerwony'}]
)
P_VERA = Species(name='Pistacia vera', local_names={EN: 'pistacchio', PL: 'pistacja właściwa'})
T_RADICANS = Species(
...
A_PSEUDOPLATANUS = Species(name='Acer pseudoplatanus', local_names={EN: 'sycamore', PL: 'klon jawor'})
A_PLATANOIDES = Species(name='Acer platanoides', local_names={EN: 'Norway maple', PL: 'klon zwyczajny'})
A_SACCHARUM = Species(
    name='Acer saccharum',
    local_names={EN: 'sugar mapple', PL: 'klon cukrowy'},
    known_for=[{EN: 'maple syrup', PL: 'syrop klonowy'}],
)
L_CHINENSIS = Species(name='Litchi chinensis', local_names={EN: 'lychee', PL: 'liczi chińskie'})
P_CUPANA = Species(name='Paullinia cupana', local_names={EN: 'guaraná', PL: 'paulinia guarana'})
C_SINENSIS = Species(name='Citrus × sinensis', local_names={EN: 'sweet orange', PL: 'pomarańcza chińska'})
C_LIMON = Species(name='Citrus limon', local_names={EN: 'lemon', PL: 'cytryna zwyczajna'})
C_PARADISI = Species(name='Citrus × paradisi', local_names={EN: 'grapefruit', PL: 'grejpfrut'})
C_MAXIMA = Species(name='Citrus maxima', local_names={EN: 'pomelo', PL: 'pomelo, pomarańcza olbrzymia'})
C_AURANTIIFOLIA = Species(name='Citrus × aurantiifolia', local_names={EN: 'key lime', PL: 'limonka, limetka, lima'})
C_RETICULATA = Species(name='Citrus reticulata', local_names={EN: 'mandarin orange', PL: 'mandarynka'})
C_TANGERINA = Species(name='Citrus x tangerina', local_names={EN: 'tangerine', PL: 'mandarynka'})
C_CLEMENTINA = Species(name='Citrus × clementina', local_names={EN: 'clementine', PL: 'klementynka'})
C_JAPONICA = Species(name='Citrus japonica', local_names={EN: 'kumquat', PL: 'kumkwat'})

ACER_SECTION_ACER = Clade(name='Acer sect. Acer', children=[A_PSEUDOPLATANUS, A_SACCHARUM])  # Section

CORE_CITRUSES = Clade(children=[
    C_SINENSIS, C_LIMON, C_PARADISI, C_MAXIMA, C_AURANTIIFOLIA, C_RETICULATA, C_TANGERINA, C_CLEMENTINA, C_JAPONICA,
])
...
ANACARDIOIDEAE = Subfamily(name='Anacardioideae', children=[ANACORDIOIDEAE_A, ANACORDIOIDEAE_C])
