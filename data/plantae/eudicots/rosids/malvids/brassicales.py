...
E_VESICARIA = Species(name='Eruca vesicaria', local_names={EN: 'rocket, arugola', PL: 'rukola'})
L_SATIVUM = Species(name='Lepidium sativum', local_names={EN: 'garden cress', PL: 'rzeżucha, pieprzyca siewna'})
B_JUNCEA = Species(
...
R_RAPHANISTRUM = Species(name='Raphanus raphanistrum', local_names={EN: 'radish', PL: 'rzodkiew zwyczajna'})
A_RUSTICANA = Species(name='Armoracia rusticana', local_names={EN: 'horseradish', PL: 'chrzan pospolity'})
E_JAPONICUM = Species(name='Eutrema japonicum', local_names={EN: 'wasabi', PL: 'wasabi, chrzan japoński'})
C_PAPAYA = Species(name='Carica papaya', local_names={EN: 'papaya', PL: 'papaja, melonowiec właściwy'})
R_ODORATA = Species(name='Reseda odorata', local_names={EN: 'garden mignonette', PL: 'rezeda wonna'})
T_MAJUS = Species(name='Tropaeolum majus', local_names={EN: 'garden nasturtium', PL: 'nasturcja większa'})
C_SPINOSA = Species(name='Capparis spinosa', local_names={EN: 'caper', PL: 'kapary cierniste'})
