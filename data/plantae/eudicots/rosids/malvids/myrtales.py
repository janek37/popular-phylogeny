...
P_DIOICA = Species(name='Pimenta dioica', local_names={EN: 'allspice', PL: 'ziele angielskie'})
F_MAGELLANICA = Species(name='Fuchsia magellanica', local_names={EN: 'hummingbird fuchsia', PL: 'fuksja magellańska'})
...
P_GRANATUM = Species(name='Punica granatum', local_names={EN: 'pomegranate', PL: 'granat właściwy'})
