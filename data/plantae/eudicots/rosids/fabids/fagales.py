...
F_SYLVATICA = Species(
    name="Fagus sylvatica", local_names={EN: "European beech", PL: "buk zwyczajny"}
)
Q_ROBUR = Species(
...
B_PENDULA = Species(
    name="Betula pendula", local_names={EN: "silver birch", PL: "brzoza brodawkowata"}
)
A_GLUTINOSA = Species(
    name="Alnus glutinosa", local_names={EN: "common alder", PL: "olcha/olsza czarna"}
)
C_AVELLANA = Species(
    name="Corylus avellana", local_names={EN: "common hazel", PL: "leszczyna pospolita"}
)
C_BETULUS = Species(
