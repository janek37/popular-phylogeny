from clade import Species, Genus, Family, Order, Subfamily, Tribe, Subtribe
from constants import EN, PL

L_SICERARIA = Species(name='Lagenaria siceraria', local_names={EN: 'calabash, bottle gourd', PL: 'tykwa pospolita'})
C_LANATUS = Species(name='Citrullus lanatus', local_names={EN: 'watermelon', PL: 'arbuz zwyczajny'})
C_SATIVUS = Species(name='Cucumis sativus', local_names={EN: 'cucumber', PL: 'ogórek siewny'})
C_MELO = Species(
    name='Cucumis melo',
    local_names={EN: 'melon, muskmelon', PL: 'melon cukrowy, ogórek melon'},
    known_for=[{EN: 'cataloupe', PL: 'kantalupa'}, {EN: 'honedew', PL: 'melon spadziowy'}],
)
C_PEPO = Species(
    name='Cucurbita pepo',
...
C_MOSCHATA = Species(name='Cucurbita moschata', local_names={PL: 'dynia piżmowa'}, known_for={EN: 'butternut squash'})
B_OBLIQUA = Species(name='Begonia × tuberhybrida', local_names={PL: 'begonia bulwiasta', EN: 'tuberous begonia'})
