...
A_CALAMUS = Species(
    name="Acorus calamus", local_names={EN: "sweet flag", PL: "tatarak zwyczajny"}
)
Z_MARINA = Species(
    name="Zostera marina",
...
L_MINOR = Species(
    name="Lemna minor", local_names={EN: "common duckweed", PL: "rzęsa drobna"}
)
L_CANDIDUM = Species(
    name="Lilium candidum", local_names={EN: "Madonna lily", PL: "lilia biała"}
)
...
T_GESNERIANA = Species(
    name="Tulipa gesneriana", local_names={EN: "garden tulip", PL: "tulipan ogrodowy"}
)
C_NUCIFERA = Species(
    name="Cocos nucifera",
...
M_PARADISIACA = Species(
    name="Musa × paradisiaca", local_names={EN: "banana", PL: "banan zwyczajny"}
)
Z_OFFICINALE = Species(
    name="Zingiber officinale", local_names={EN: "ginger", PL: "imbir lekarski"}
)
