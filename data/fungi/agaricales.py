...
F_VELUTIPES = Species(
    name="Flammulina velutipes", local_names={EN: "enoki", JP: "enokitake"}
)
H_TESSELLATUS = Species(
    name="Hypsizygus tessellatus", local_names={EN: "beech/clamshell mushroom"}
)
P_OSTREATUS = Species(
...
A_MUSCARIA = Species(
    name="Amanita muscaria", local_names={PL: "muchomor czerwony", EN: "fly agaric"}
)
