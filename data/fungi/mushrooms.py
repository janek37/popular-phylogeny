from clade import Phylum, Species, Genus, Family, Order, Class, Clade
from constants import EN, PL, JP, IT
...
B_EDULIS = Species(name='Boletus edulis', local_names={IT: 'fungo porcino', PL: 'borowik szlachetny'})
C_CIBARIUS = Species(name='Cantharellus cibarius', local_names={EN: 'chantarelle', PL: 'kurka, pieprznik jadalny'})
L_SULPHUREUS = Species(name='Laetiporus sulphureus', local_names={EN: 'chicken-of-the-woods'})
R_SATANAS = Species(name='Rubroboletus satanas', local_names={PL: 'borowik szatański', EN: "Satan's bolete"})
L_DELICIOSUS = Species(name='Lactarius deliciosus', local_names={PL: 'mleczaj rydz', EN: 'saffron milk cap'})
...
AGARICOMYCETIDAE = Clade(name='Agaricomycetidae', children=[AGARICALES, BOLETALES])  # Subclass
...
AGARICOMYCETES = Class(name='Agaricomycetes', children=[AGARICOMYCETES_C, CANTHARELLALES])
